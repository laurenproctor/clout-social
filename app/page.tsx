    ...
    <main className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans">
              ...
              <div className="absolute right-0 mt-2 w-72 bg-slate-900 border border-slate-800 rounded-xl shadow-2xl p-3 z-50 text-left">
                ...
                {reauthAlerts.length === 0 ? (
                  ...
                  <ul className="space-y-1.5">
                    ...
                    <li className="pt-1">
                      <Link href="/studio" className="text-[11px] text-emerald-400 hover:text-emerald-300 font-medium">
      ...
      {mobileNavOpen && (
        <nav className="lg:hidden border-b border-slate-800/80 bg-slate-900/70 backdrop-blur-md px-4 py-3 space-y-1">
          ...
          <Link href="/studio" className="flex items-center gap-3 px-3 py-2 rounded-xl text-slate-300 hover:bg-slate-800/50 text-sm font-medium">
